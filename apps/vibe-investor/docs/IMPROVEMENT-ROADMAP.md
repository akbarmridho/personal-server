...
| 2.4 | Skill output contract: fundamental conviction score | PLANNED | `tasks/2.4-fundamental-conviction-score.md` | 2.0 validated |
| 2.5 | Skill output contract: PM produces constraints not verdicts | PLANNED | `tasks/2.5-pm-constraints.md` | 2.0 validated |
