...
- Mandatory memory context: `memory/market/plan.md`, `get_state`, and the latest prior explore-idea artifact if found. Surface any `get_state` warnings (staleness, status mismatches) in the output.
