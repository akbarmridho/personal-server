...
- Mandatory memory context: `memory/MEMORY.md`, `memory/market/plan.md`, `get_state({ types: ["symbols", "theses", "watchlist"] })`, and the latest prior explore-idea artifact if found.
