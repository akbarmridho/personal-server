...
- Mandatory memory context: `memory/MEMORY.md`, `memory/market/plan.md`, `memory/notes/agent-performance.md`, `memory/notes/portfolio-monitor.md`, `memory/notes/thesis.md`, `memory/notes/watchlist.md`, `memory/theses/**/thesis.md`, `memory/symbols/**/plan.md`, and the latest prior deep review if found.
